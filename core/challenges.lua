...
addon.Challenges = {
    ...
    ["CraftedLockedSolo"] = {
        ...
        description = "Start with no gear. You may only wear items on your allow list; eligible new crafts add themselves. Rings, neck, and trinkets are exempt—any of those may be worn. Completing either Crafted Locked variant marks both as done in the hub.",
    ...
    ["CraftedLockedDuo"] = {
        ...
        description = "Same gear rules as solo (rings, neck, and trinkets exempt). Trade once with your saved partner to merge both allow lists. Completing either Crafted Locked variant marks both as done in the hub.",
