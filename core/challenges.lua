...
addon.Challenges = {
    ...
    ["CraftedLockedSolo"] = {
        ...
        description = "Start naked. You may only wear gear whose item ID is on your allow list (new crafts add the ID). Rings, neck, and trinkets are exempt—any may be worn. Any copy of an allowed item type is fine—the list is per item ID, not per unique item.",
    ...
    ["CraftedLockedDuo"] = {
        ...
        description = "Same ID allowlist as solo (rings, neck, and trinkets exempt). Crafts add IDs automatically. With the addon, opening trade with your saved partner merges both allowlists (union).",
